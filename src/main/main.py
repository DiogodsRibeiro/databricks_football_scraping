...
from src.data_processing_scraping.get_incremental_results import carga_incremental_results
from src.data_processing_scraping.get_all_data_calendar import carga_calendario
from src.data_processing_scraping.get_all_urls_statistics import coletar_urls_estatisticas
from src.data_processing_scraping.get_incremental_statistics import coletar_estatisticas_partidas_incremental
